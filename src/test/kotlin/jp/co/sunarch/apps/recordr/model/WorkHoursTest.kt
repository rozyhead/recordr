...
class WorkHoursTest {
  ...
  @Test
  fun test_toJson() {
    val hours = WorkHours.ofMinutes(450)
    assertThat(objectMapper.writeValueAsString(hours))
        .isEqualTo("7.50")
  }

  @Test
  fun test_fromJson() {
    assertThat(objectMapper.readValue("7.5", WorkHours::class.java))
        .isEqualTo(WorkHours.ofMinutes(450))
  }
